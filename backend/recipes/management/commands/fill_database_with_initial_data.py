...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        text_plum_cake = (
            ...
            + " после каждого добавленного яйца.\n"
